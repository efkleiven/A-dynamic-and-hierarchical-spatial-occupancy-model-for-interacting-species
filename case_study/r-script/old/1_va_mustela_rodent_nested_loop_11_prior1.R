...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
          ...
          for(i in 1:nvisits) {
           ...
           # Draw a replicate data set under the fitted model
            ...
            yrep[i] ~ dcat(dpm[time_id[i], , z[site_id[i], block_id[i], time_id[i]]] + 0.002)
...
for(q2 in 1:length(uniq_site1_t0)){
     ...
     # Det. frequencies for observed and replicated data
      ...
      for (day in 1:nsurvey){
        tmp_A[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],day,uniq_time1_t0[q2]] <- z_A[(uniq_block1_t0[q2]-1)*6 + uniq_site1_t0[q2], uniq_time1_t0[q2]] * pA[uniq_time1_t0[q2]]
        tmp_B[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],day,uniq_time1_t0[q2]] <- z_B[(uniq_block1_t0[q2]-1)*6 + uniq_site1_t0[q2], uniq_time1_t0[q2]] * pB[uniq_time1_t0[q2]]
      }
      ...
      x2Closed_A[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]] <- ifelse(whichNA2[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]]==1, 1 , 
      ...
      ftClosed_A[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]] <- ifelse(whichNA2[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]]==1, 1 ,
      ...
      x2Closed_B[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]] <- ifelse(whichNA2[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]]==1, 1 ,
      ...
      ftClosed_B[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]] <- ifelse(whichNA2[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]]==1, 1 ,
      ...
      x2repClosed_A[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]] <- ifelse(whichNA2[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]]==1, 1 ,
      ...
      ftrepClosed_A[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]] <- ifelse(whichNA2[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]]==1, 1 ,
      ...
      x2repClosed_B[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]] <- ifelse(whichNA2[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]]==1, 1 , 
      ...
      ftrepClosed_B[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]] <- ifelse(whichNA2[(uniq_block1_t0[q2]-1)*6+uniq_site1_t0[q2],uniq_time1_t0[q2]]==1, 1 ,
...
# MCMC settings
ni <- 1000   ;   nt <- 10   ;   nb <- 200  ;   nc <- 4    ;   na <- 200
...
# Save model
setwd("./model_output")
save(out.gof, file="va_snowbed_mustela_rodent_outgof_jagui_nestedloop11_ni500_pri1_4.rda")
#~ End of script