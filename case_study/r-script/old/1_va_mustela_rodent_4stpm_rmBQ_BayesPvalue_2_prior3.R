...
out.gof_pri3 <- jags(data, inits=inits, params, "mod_spatial_dynocc_bayp.txt", n.chains = nc,
                                                     n.thin = nt, n.iter = ni, n.burnin = nb, n.adapt=na, parallel = T)

# Save model
setwd("./model_output")
save(out.gof_pri3, file="va_snowbed_mustela_rodent_outgof_pri3.rda")
