...
params <- c("gamA","gamB","gamAB","gamBA","epsA","epsB","epsAB","epsBA","psi",
            "GamA","GamB","GamAB","GamBA","EpsA","EpsB","EpsAB","EpsBA", "Psi", "pA","pB","z","x",
            "alphaA0","alphaB0","alphaA1","alphaB1")

# MCMC settings
ni <- 250000   ;   nt <- 20   ;   nb <- 50000   ;   nc <- 4    ;   na <- 20000

# run model in jags
setwd("../")

va_snowbed_mustela_rodent_sdet_s1_203_ni250k <- jags(data, inits=inits, params, "hidden_block_seas_det.txt", n.chains = nc,
