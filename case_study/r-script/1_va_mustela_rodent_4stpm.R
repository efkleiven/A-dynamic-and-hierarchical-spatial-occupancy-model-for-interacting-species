...
# MCMC settings
ni <- 50000   ;   nt <- 20   ;   nb <- 5000   ;   nc <- 4    ;   na <- 15000

# run model in jags
setwd("../")

va_snowbed_mustela_rodent_sdet_4stpm <- jags(data, inits=inits, params, "mod_seas_det_4stpm.txt", n.chains = nc,
                                                     n.thin = nt, n.iter = ni, n.burnin = nb, n.adapt=na, parallel = T)

# Save model
setwd("./model_output")
save(va_snowbed_mustela_rodent_sdet_4stpm, file="va_snowbed_mustela_rodent_sdet_4stpm_test.rda")
