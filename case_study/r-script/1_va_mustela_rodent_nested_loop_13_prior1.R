...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
          ...
          for(i in 1:nvisits) {
            ...
            y[i] ~ dcat( dpm[time_id[i], ( 1:nout ) , z[site_id[i], block_id[i], time_id[i]]] + 0.001)  # +0.01 to avoide giving the dcat a prob of 0 
...
# Save model
setwd("./model_output")
save(out.gof, file="va_snowbed_mustela_rodent_outgof_jagui_nestedloop13_ni1k_pri1.rda")
#~ End of script