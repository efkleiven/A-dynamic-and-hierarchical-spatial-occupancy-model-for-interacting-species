...
load("va_snowbed_mustela_rodent_outgof_jagui_nestedloop13_ni1k_pri1.rda")
load("va_snowbed_mustela_rodent_outgof_jagui_nestedloop14_ni1k_pri1.rda")
load("va_snowbed_mustela_rodent_outgof_jagui_nestedloop15_ni1k_pri1.rda")
load("va_snowbed_mustela_rodent_outgof_nestedloop_temp_ni1k_pri1_2.rda")


load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri1.rda")
load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri1_01.rda")
load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri1_005.rda")
load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri1_001.rda")
load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri1_0005.rda")

load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri2_01.rda")
load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri2_005.rda")
load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri2_001.rda")
...
load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri3_01.rda")
load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri3_005.rda")
load("va_snowbed_mustela_rodent_gof_nestedloop_temp_pri3_001.rda")
