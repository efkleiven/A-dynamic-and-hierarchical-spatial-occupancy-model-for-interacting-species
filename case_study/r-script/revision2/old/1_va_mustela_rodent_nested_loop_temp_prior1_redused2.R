...
load("occm_vole_mustelid_snowbed_2016_2020.rda")
...
# MCMC settings
ni <- 40000   ;   nt <- 10   ;   nb <- 20000  ;   nc <- 6    ;   na <- 10000
...
save(out.gof1, file="va_snowbed_mustela_rodent_gof_pri1_005_2016_2020.rda")
#~ End of script