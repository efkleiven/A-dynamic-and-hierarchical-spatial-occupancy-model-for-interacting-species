...
## In this script we simulate data under the low detection scenario               ##
##                                                                                ##
...
z_low_det <- array(dim = c(ndat, M, B, T)) # latent site state
x_low_det <- array(dim = c(ndat, B, T))    # latent block state
