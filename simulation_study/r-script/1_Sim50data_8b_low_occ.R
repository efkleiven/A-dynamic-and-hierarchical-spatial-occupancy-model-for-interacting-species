...
for(d in 1:ndat){
  for(t in 1:(T-1)){
    ...
    for(i in 1:M){ # Loop over sites
      z_low_occ[d, i,b,t+1] <- rcat(1, stpm[ ,z_low_occ[d,i,b,t], x_low_occ[d,b,t+1]])
      }}}}
...
save(y_low_occ, file="simdata_50set_50seas_8b_y_low_occ.rda")
save(z_low_occ, file="simdata_50set_50seas_8b_z_low_occ.rda")
save(x_low_occ, file="simdata_50set_50seas_8b_x_low_occ.rda")
