...
for(i in 1:M){ # Loop over sites
    z_hig_occ[d, i,b,t+1] <- rcat(1, stpm[,z_hig_occ[d,i,b,t], x_hig_occ[d,b,t]])
    }}}}
...
save(y_hig_occ, file="simdata_50set_50seas_8b_y_hig_occ.rda")
save(z_hig_occ, file="simdata_50set_50seas_8b_z_hig_occ.rda")
save(x_hig_occ, file="simdata_50set_50seas_8b_x_hig_occ.rda")